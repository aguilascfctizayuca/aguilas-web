    ...
    <section className="redes-section">
      <div className="redes-container reveal" ref={ref}>
        ...
        <div className="redes-cards">
          ...
          <a href="https://wa.me/527711107903?text=Hola,%20me%20interesa%20saber%20mas%20sobre%20Aguilas%20CFC" target="_blank" rel="noopener noreferrer" className="red-card" style={{ background: 'linear-gradient(135deg, #1a1a2e, #1a2e1a)' }}>
            <div className="red-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
