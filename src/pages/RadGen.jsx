      ...
      <div style={{ position: 'relative', zIndex: 1, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <section style={{
          ...
          <p style={{
            ...
            Síguenos y entérate primero cuando la señal de RadGen Mx esté en el aire.
          </p>
          ...
          <a
            ...
            className="glass radgen-red-card"
            style={{ maxWidth: '320px', margin: '0 auto' }}
          >
            <div className="radgen-red-icon">
            ...
            <div className="radgen-red-info">
              <span className="radgen-red-nombre">Instagram</span>
              <span className="radgen-red-handle">@radgen.mx</span>
            </div>
            <span className="radgen-red-cta">Síguenos</span>
          </a>
        </section>
